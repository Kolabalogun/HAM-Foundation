...
const Roles: React.FC = () => {
  return (
    <section className="center  flex flex-1 flex-col lg:flex-row justify-between     py-44   gap-12 px-5 sm:px-10 ">
      <div className=" bg-primary text-white flex-1 flex flex-col gap-5 max-w-lg xl:w-full items-center text-center z-50 lg:-mt-32 cursor-pointer px-6 lg:px-12 py-12 rounded-3xl ">
      ...
      <div className=" bg-primary text-white flex-1 flex flex-col gap-5 max-w-lg xl:w-full items-center text-center z-50 -mt-0  lg:-mt-32 cursor-pointer px-6 lg:px-12 py-12 rounded-3xl ">
